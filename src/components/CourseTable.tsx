...
import { Trash2, CalendarPlus, CalendarX, Edit, ChevronDown, ChevronUp, Search } from 'lucide-react';
                ...
                <tr key={course.id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs text-gray-500 dark:text-gray-400">Grupo: {course.group}</span>
                    </div>
                  </td>
